# RocketMQ源码分析之Consumer端(下）

consumer端是通过PullMessageService线程不断拉取消息
...
![image.png](RocketMQ源码分析之Consumer端(下）.assets/1595407281203-2eda6f26-cef1-4fa0-8fac-998e5009d646.png)
...
这个Service是用来消费message的





首先会进入submitConsumeRequest方法
...
其中可以看到将ConsumeRequest放入线程池中等待运行



我们可以看到ConsumeRequest其实继承了Runnable
...
![image.png](RocketMQ源码分析之Consumer端(下）.assets/1595485727795-e82f74a7-fa0c-4695-af38-4ff8b274284c.png)

对于集群模式会定时将offset同步到Broker,广播模式会定时存储到本地